...
CUDA_VISIBLE_DEVICES=7 python training/exp_runner.py --conf ./confs/dnerf_transformers_spring_Gaus.conf --scan_id -1 --is_continue --timestamp 2024_12_22_09_54_14